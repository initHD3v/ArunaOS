  ...
  return (
    <div className="bg-background text-foreground flex h-full w-full flex-col">
      ...
      <div className="border-border/30 flex items-center gap-2 border-b px-4 py-2">
        <Search size={12} className="text-foreground/50 shrink-0" />
        <input
          value={filter}
          onChange={(e) => setFilter(e.target.value)}
          placeholder="Cari aplikasi..."
          className="text-foreground placeholder:text-foreground/40 min-w-0 flex-1 bg-transparent text-[11px] outline-none"
        />
      </div>
